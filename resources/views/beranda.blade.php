    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <!--begin::Logo image-->
                                <a href="landing.html">
                                    <img alt="Logo" src="{{asset('assets/img/assalam.png')}}"
                                ...
                                <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-semibold"
                                        ...
                                        <div class="menu-item">
                                            <!--begin::Menu link-->
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#achievements"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Jurusan</a>
                                            <!--end::Menu link-->
                                        </div>
                                        ...
                                        <div class="menu-item">
                                            <!--begin::Menu link-->
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#achievements"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Eskul</a>
                                            <!--end::Menu link-->
                                        </div>
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        <!--begin::Title-->
                        <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">SMK ASSALAAM BANDUNG
                            <br />
                            <span
                                style="background: linear-gradient(to right, #0c10f7 0%, #f1f9ea 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                                <span id="kt_landing_hero_text">Sekolah Terbaik Sepanjang Masa</span>
                            </span>
                        </h1>
                        <!--end::Title-->
                        <!--begin::Action-->
                        <a href="index.html" class="btn btn-primary">Daftar Sekarang</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Clients-->
                    <div class="d-flex flex-center flex-wrap position-relative px-5">
                        ...
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Fujifilm">
                            <img src="{{asset('assets/img/logos/fuso.png')}}" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Vodafone">
                            <img src="{{asset('assets/img/logos/google.png')}}" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="KPMG International">
                            <img src="{{asset('assets/img/logos/hondaa.png')}}" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Nasa">
                            <img src="{{asset('assets/img/logos/mitsubishi.png')}}" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Aspnetzero">
                            <img src="{{asset('assets/img/logos/mozila.webp')}}" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Aspnetzero">
                            <img src="{{asset('assets/img/logos/toyota.png')}}" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                    </div>
                    <!--end::Clients-->
        ...
        <div class="mb-n10 mb-lg-n20 z-index-2">
            ...
            <div class="container">
                ...
                <div class="text-center mb-17">
                    ...
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="fs-5 text-muted fw-bold">Kenapa Harus Bersekolah Di SMK ASSALAAM
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Heading-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="d-flex flex-center mb-5">
                                ...
                                <!--end::Badge-->
                                <!--begin::Title-->
                                <div class="fs-5 fs-lg-3 fw-bold text-dark">Keunggulan</div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Description-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="d-flex flex-center mb-5">
                                ...
                                <!--end::Badge-->
                                <!--begin::Title-->
                                <div class="fs-5 fs-lg-3 fw-bold text-dark">Jaminan Pendidikan</div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <div class="fw-semibold fs-6 fs-lg-4 text-muted">
                                <p>
                                    Anak didik dipersiapkan untuk bekerja, berwirausaha maupun melanjutkan ke perguruan
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="d-flex flex-center mb-5">
                                ...
                                <!--end::Badge-->
                                <!--begin::Title-->
                                <div class="fs-5 fs-lg-3 fw-bold text-dark">Kerjasama Dunia Industri</div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Description-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="d-flex flex-center mb-5">
                                ...
                                <!--end::Badge-->
                                <!--begin::Title-->
                                <div class="fs-5 fs-lg-3 fw-bold text-dark">Sertifikasi</div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Description-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="d-flex flex-center mb-5">
                                ...
                                <!--end::Badge-->
                                <!--begin::Title-->
                                <div class="fs-5 fs-lg-3 fw-bold text-dark">Fasilitas</div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Description-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            ...
                            <div class="d-flex flex-center mb-5">
                                ...
                                <!--end::Badge-->
                                <!--begin::Title-->
                                <div class="fs-5 fs-lg-3 fw-bold text-dark">Lulusan</div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <div class="fw-semibold fs-6 fs-lg-4 text-muted">
                                <p>Lulusan SMK Assalaam dibekali dengan kemampuan yang disesuaikan Kebutuhan
                                    Industri, mempunyai Budaya Kerja Tinggi dan Terampil bekerja.</p>
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                ...
                <div class="tns tns-default">
                    ...
                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{asset('assets/img/assalaam1.jpg')}}" width="820px"
                                class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{asset('assets/img/assalaam2.jpg')}}" class="card-rounded shadow mw-100"
                                width="820px" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{asset('assets/img/assalaam3.jpg')}}" class="card-rounded shadow mw-100"
                                width="820px" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
        ...
        <div class="mt-sm-n10">
            ...
            <div class="pb-15 pt-18 landing-dark-bg">
                ...
                <div class="container">
                    <!--begin::Heading-->
                    <div class="mt-15 mb-18" id="achievements" data-kt-scroll-offset="{default: 100, lg: 150}">
                        <!--begin::Title-->
                        <h3 class="fs-2hx text-white fw-bold mb-5">Profil</h3>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="fs-5 text-gray-700 fw-bold">
                            <p>SMK Assalaam merupakan sekolah kejuruan dengan kompetensi keahlian teknik kendaraan
                                ringan (roda empat) plus
                                sepeda motor dalam proses pendidikan pelatihan. Peka terhadap perubahan perkembangan
                                teknologi baru dan tuntutan
                                kebutuhan pasar kerja, agar lulusannya siap menghadapi perubahan.</p>
                            <p>SMK Assalaam dengan penuh kesadaran berani melakukan perubahan dengan berbagai inovasi
                                dan improvisasi, mencari
                                terobosan untuk meraih keberhasilan bagi peserta didiknya.</p>
                            <p>Tekad tersebut sebagai wujud nyata dari SMK Assalaam didukung oleh sarana praktek yang
                                lengkap UP TO DATE, waktu
                                praktek memadai dan praktek berstandar industri dengan pelayanan prima.</p>
                        </div>

                        <h3 class="fs-2hx text-white fw-bold mb-5">Keunggulan</h3>
                        <div class="fs-5 text-gray-700 fw-bold">
                            <ol>
                                <li>Program pembelajaran disusun berdasarkan standar Nasional dan dikembangkan
                                    berdasarkan
                                    kebutuhan industri
                                    serta bekerjasama dengan DU/DI (Dunia Usaha/Dunia Industri)</li>
                                <li>Menghasilkan lulusan yang siap bekerja,memiliki mentalitas kerja yang tangguh, dan
                                    memiliki keterampilan
                                    ganda (jurusan otomotif : Mobil + Motor, jurusan RPL : programer + teknisi)
                                </li>
                                <li>Tenaga pendidik berasal dari lulusan perguruan-perguruan tinggi terkemuka, dan
                                    pelaku
                                    Industri </li>
                                <li>Setiap pelajaran praktek/paket keahlian dilaksanakan dengan menggunakan sistem blok,
                                    dengan 3 guru pengajar.
                                </li>
                                <li>Ujian Kompetensi diselenggarakan secara mandiri, menggunakan kendaraan dan alat yang
                                    mutakhir . </li>
                                <li>Pengembangan karakter dibentuk atas dasar ajaran ISLAM sebagai fondasi utama dalam
                                    berbagai aktivitas siswa.
                                </li>
                                <li>Dibukanya layanan Bursa Kerja Khusus yang menyediakan pelatihan tambahan siswa untuk
                                    siap bekerja dan
                                    penyaluran lulusan ke dunia kerja </li>
                                <li>Memiliki unit produksi SMK Assalaam yang menjadi laboratorium langsung bagi siswa
                                    dalam
                                    mengembangkan
                                    keterampilan kejuruannya.</li>
                                <li>Sarana dan prasarana pembelajaran yang lengkap dan terkini </li>
                            </ol>
                        </div>

                        <h3 class="fs-2hx text-white fw-bold mb-5">Visi</h3>
                        <div class="fs-5 text-gray-700 fw-bold">
                            <p>Menjadikan SMK Assalaam sebagai sekolah IDAMAN</p>
                        </div>

                        <h3 class="fs-2hx text-white fw-bold mb-5">Misi</h3>
                        <div class="fs-5 text-gray-700 fw-bold">
                            <ul class="list list--standard">
                                <li>
                                    <a href="#!">Intelek dalam melaksanakan proses pembelajaran</a>
                                </li>
                                <li>
                                    <a href="#!">Disiplin dalam segala aspek kehidupan</a>
                                </li>
                                <li>
                                    <a href="#!">Amanah dalam melaksanakan tugas</a>
                                </li>
                                <li>
                                    <a href="#!">Maju dan menang untuk kepentingan bersama</a>
                                </li>
                                <li>
                                    <a href="#!">Aktif dalam merespon perkembangan</a>
                                </li>
                                <li>
                                    <a href="#!">Norma islam sebagai landasan dalam beraktifitas</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                                        <div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="461"
                                            data-kt-countup-suffix="+">0</div>
                                    </div>
                                    <!--end::Value-->
                                    <!--begin::Label-->
                                    <span class="text-gray-600 fw-semibold fs-5 lh-0">Pendaftaran</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Info-->
                            </div>
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    ...
                                    <!--end::Value-->
                                    <!--begin::Label-->
                                    <span class="text-gray-600 fw-semibold fs-5 lh-0">Lolos Seleksi</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Info-->
                            </div>
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    ...
                                    <!--end::Value-->
                                    <!--begin::Label-->
                                    <span class="text-gray-600 fw-semibold fs-5 lh-0">Di Terima</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Info-->
                            </div>
                    ...
                    <div class="fs-2 fw-semibold text-muted text-center mb-3">
                        <span class="fs-1 lh-1 text-gray-700">“</span>Sekolah berkualitas dengan program pembelajaran
                        yang berkualitas, sumber daya pengajar yang berkualitas, dan sarana
                        prasarana yang lengkap dan mutakhir
                        <span class="fs-1 lh-1 text-gray-700">“</span>
                    </div>
                    <!--end::Testimonial-->
                    <!--begin::Author-->
                    <div class="fs-2 fw-semibold text-muted text-center">
                        <a href="account/security.html" class="link-primary fs-4 fw-bold">SMK</a>
                        <span class="fs-4 fw-bold text-gray-600">ASSALAAM BANDUNG</span>
                    </div>
                    <!--end::Author-->
                </div>
                <!--end::Container-->
                        ...
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-primary py-20 px-10">
                                ...
                                <div class="w-100 mb-10">
                                    ...
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack mb-5">
                                        <span class="fw-semibold fs-6 text-white opacity-75 text-start pe-3">Keen
                                    ...
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack mb-5">
                                        <span class="fw-semibold fs-6 text-white opacity-75 text-start pe-3">Targets
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            ...
                            <!--end::Logo image-->
                            <!--begin::Logo image-->
                            <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1" href="https://keenthemes.com/">© 2022
                                Keenthemes Inc.</span>
                            <!--end::Logo image-->
                        </div>
                        <!--end::Copyright-->
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="index-2.html" class="btn btn-sm btn-success shadow">Demo 1</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo2/index.html" class="btn btn-sm btn-success shadow">Demo
                                                2</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo3/index.html" class="btn btn-sm btn-success shadow">Demo
                                                3</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo4/index.html" class="btn btn-sm btn-success shadow">Demo
                                                4</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo5/index.html" class="btn btn-sm btn-success shadow">Demo
                                                5</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo6/index.html" class="btn btn-sm btn-success shadow">Demo
                                                6</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo7/index.html" class="btn btn-sm btn-success shadow">Demo
                                                7</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo8/index.html" class="btn btn-sm btn-success shadow">Demo
                                                8</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo9/index.html" class="btn btn-sm btn-success shadow">Demo
                                                9</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo10/index.html" class="btn btn-sm btn-success shadow">Demo
                                                10</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo11/index.html" class="btn btn-sm btn-success shadow">Demo
                                                11</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo12/index.html" class="btn btn-sm btn-success shadow">Demo
                                                12</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo13/index.html" class="btn btn-sm btn-success shadow">Demo
                                                13</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo14/index.html" class="btn btn-sm btn-success shadow">Demo
                                                14</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo15/index.html" class="btn btn-sm btn-success shadow">Demo
                                                15</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo16/index.html" class="btn btn-sm btn-success shadow">Demo
                                                16</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo17/index.html" class="btn btn-sm btn-success shadow">Demo
                                                17</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo18/index.html" class="btn btn-sm btn-success shadow">Demo
                                                18</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo19/index.html" class="btn btn-sm btn-success shadow">Demo
                                                19</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo20/index.html" class="btn btn-sm btn-success shadow">Demo
                                                20</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo21/index.html" class="btn btn-sm btn-success shadow">Demo
                                                21</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <a href="../demo22/index.html" class="btn btn-sm btn-success shadow">Demo
                                                22</a>
                                        </div>
                                    </div>
                                    <!--end::Demo-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jul 2022 03:10:45 GMT -->
