...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <form class="form d-flex flex-column flex-lg-row" action="{{ route('eskul.update', $eskul->id) }}" method="POST"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <textarea name="deskripsi" cols="30" rows="7"
                                ...
                                disabled>{{$eskul->deskripsi}}</textarea>
                            @error('deskripsi')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="d-flex justify-content-end">
                    <!--begin::Button-->
                    <a href="{{route('eskul.index')}}" class="btn btn-light me-5">kembali</a>
                    <!--end::Button-->
                </div>
            </div>
            <!--end::Main column-->
