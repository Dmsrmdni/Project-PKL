...
<div class="container">
    ...
    <div class="row">
        <div class="col-xl">
            ...
            <a href="{{route('pendaftaran.index')}}"><button type="submit" class="btn btn-primary">Kembali</button></a>
        </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_lengkap_ortu"
                            ...
                            placeholder="Nama Lengkap Ortu" value="{{ $pendaftaran->nama_lengkap_ortu }}" disabled />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pekerjaan"
                            class="form-control mb-2  @error('pekerjaan') is-invalid @enderror" placeholder="Pekerjaan"
